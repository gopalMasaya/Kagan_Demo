...
else  if(searchFeild == 'צריך הסעה'){container1[x]= transporting[x];}
...
else  if(searchFeild == 'מעגל שיוך'){container2[x]= innerCircul[x];}  
else  if(searchFeild == 'צריך הסעה'){container2[x]= transporting[x];}
